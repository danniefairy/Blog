...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left w3-opacity w3-hover-opacity-off" style="z-index:3;width:300px;" id="mySidenav"><br>
  <div class="w3-container">
    ...
    <h4 class="w3-padding-0" style="font-size:200%;"><b>My Profile</b></h4>
  </div>
  <a href="/Blog" class="w3-padding w3-text-teal" style="font-size:150%;">HOME</a>
  <a href="/post/profilepageaboutme" class="w3-padding" style="font-size:150%;">PROFILE</a>
  <a href="/mail" class="w3-padding" style="font-size:150%;">CONTACT</a>
  ...
  <div id="iot" class="w3-row-padding" style="border-style:inset;">
   <br>
    <div class="w3-third w3-container w3-margin-bottom">
      ...
      <img src="/profile/iot/smartchair.png" alt="Norway" style="width:100% " class="w3-hover-opacity">
      <div class="w3-container w3-white">
        <p><b>RealTek Workshop</b></p>
        <p>My partner and I build a Smartchair by Ameba borad which can capture the postures of human body when they are sitting,and then alarm user for correct posture. Simultaneously, The Smartchair will record the data uploading to our Web.</p>
      </div>
    </div>
    <div class="w3-third w3-container w3-margin-bottom">
      <img src="/profile/iot/Clickit.jpg" alt="Norway" style="width:100%;" class="w3-hover-opacity">
      <div class="w3-container w3-white">
        <p><b>My product</b></p>
        <p>The system is called 'Clickit' which means "click it". I built an app on my phone to capture the rhythm that I click on the screen,and transforms,normalizes it in to a stream of codes. Then I transmitted the codes to my raspberry pi which controls the door lock. The product has the hierachical authentication, complete database and gmail api,so the user or the host will use my product flexibly and conveniently.</p>
      </div>
    </div>
    <div class="w3-third w3-container">
      <img src="/profile/iot/car.png" alt="Norway" style="width:100%" class="w3-hover-opacity">
      <div class="w3-container w3-white" >
        <p><b>My product</b></p>
        <p>The remote control using raspberry pi and a camera. This car is controlled by my app and can transmit the video streaming in time.</p>
      </div>
    </div>
  </div>
    <!-- iot-->
  ...
  <div class="w3-row-padding">
    <div class="w3-third">
      ...
      <lu>
        ...
        <li><p>A contented mind is a perpetual feast.</p></li>
        <li><p>Never put off till tomorrow what you can do today.</p></li>        
      </lu>
    </div>
    ...
    <div class="w3-third">
      ...
      <?php $x=0;?>
        @foreach($blogs as $blog)
        <?php $key[$x]=$blog->category_id?>
        <?php $x++; ?>
        @endforeach
        <?php $tags=array_unique($key) ?>
        @foreach($tags as $tag)
        <a  onclick="location.href='/categories/tag/{{$tag}}'" ><span class="w3-btn w3-black w3-margin-bottom">{{$categories[$tag-1]->name}}</span></a> <!-- tag example -->
        @endforeach
              </p>
    </div>
