...
<ul class="w3-navbar w3-black w3-opacity w3-hover-opacity-off">
  ...
  <li><a href="/profile/profilepageaboutme" style="font-size: 200%";>Profile</a></li>
...
<br><br><br>
<form class="w3-container w3-section w3-blue w3-opacity w3-hover-opacity-off" action="/post" method="post">
<h2 class="w3-card-4" style="text-align:center; color:white;">Create new post</h2>
