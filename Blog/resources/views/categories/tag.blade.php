...
<!--行槓 -->
<!--post index-->
<h1 style="text-align:center; color:white;"> Articles about {{$category->name}} </h1>
<?php $i=0 ?>
...
<?php if($blog->category_id==$category->id) {?>
  ...
  <?php } ?>
<img style="display:block; margin:auto; max-height:12.5cm;" class="w3-circle"  id='pic1' src="{{$blog->img}}"  class=" w3-border w3-padding w3-opacity w3-hover-opacity-off" style="width:50%" class="w3-hover-opacity" >
<br>
</div>
