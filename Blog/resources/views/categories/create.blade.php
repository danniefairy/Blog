...
<br><br><br>
<form class="w3-container w3-section w3-blue w3-opacity w3-hover-opacity-off" action="/categories" method="post">
<h2 class="w3-card-4" style="text-align:center; color:white;">Add new category</h2>
  

  


	<input class="w3-input w3-border w3-container w3-section w3-white w3-opacity w3-hover-opacity-off"  type="text" name="categoryname" value="" placeholder="Name of Category "><br>
