...
<form class="w3-container w3-section w3-blue w3-opacity w3-hover-opacity-off" action="" method="post">
		<h2 class="w3-card-4" style="text-align:center; color:white;">Email</h2>

	<input class="w3-input w3-border w3-container w3-section w3-white w3-opacity w3-hover-opacity-off"  type="text" name="sender" value="" placeholder="name"><br>
	<input class="w3-input w3-border w3-container w3-section w3-white w3-opacity w3-hover-opacity-off"  type="text" name="email" value="" placeholder="email address"><br>
	<input class="w3-input w3-border w3-container w3-section w3-white w3-opacity w3-hover-opacity-off"  type="text" name="title" value="" placeholder="this is title"><br>
	<textarea class="w3-input w3-border w3-sand" name="description" rows="8" cols="40" placeholder="this is description"></textarea><br>


	<input type="hidden" name="_token" value="{{ csrf_token() }}">
	<div style="text-align:center;">
		<input   class="w3-btn w3-round-xxlarge" type="submit" name="name" value="post" >
	</div>
	<br>
</form>
	</form>
